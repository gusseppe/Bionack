	...
	<body>
	  ...
	  <!-- Formulario  -->
		<div class="bs-example">
			<center>
			 <form action="FiltrarPorDistanciasC.php" method="post">
				 ...
				 <!-- Rango -->
				  <div class="form-group">
						<label for="inputEmail">Distancia</label>
							<input name="distancia" type="text" class="form-control" style="width:100px;" id="inputEmail" placeholder="%" value=0>
				  </div>
