...
<html lang="en">
	...
	<?php
	  ...
	  <ul class="pager">
		 <li><a href="FiltrarPorDistanciasV.php">Volver</a></li>
	  </ul>
...
NO_MORE;
				...
				<hr style="width:500px;" class="divider">
				 ...
				 <!-- Rango -->
				  <div class="form-group">
						<label for="inputEmail">Rango</label>
							<input type="text" class="form-control" style="width:100px;"id="inputEmail" placeholder="%" value=$distancia>
				  </div>
...
NO_MORE;
					...
					$filtro = filtrarPorDistancia($distancia, $res1,$res2,$res3,$sec1,$sec2,$sec3);
