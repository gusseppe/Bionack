	...
	<body>
	  ...
	  <!-- Formulario  -->
		<div class="bs-example">
			<center>
			 <form action="CalcularTodoC.php" method="post">
...
NO_MORE;
				 ...
				 <!-- Distancia--> 
				  <div class="form-group">
						<label for="inputEmail">Distancia</label>
						<input name="distancia" type="text" class="form-control" style="width:100px;"id="inputEmail" placeholder="Numero" value=0>
				  </div>

				 <!-- Radio Conservacion --> 
				  <div class="form-group">
						<label for="inputEmail">Radio de Conservacion</label>
						<input name="radioconservacion" type="text" class="form-control" style="width:100px;"id="inputEmail" placeholder="Numero" value=0>
				  </div>

				 <!-- Conservacion --> 
				  <div class="form-group">
						<label for="inputEmail">Conservacion</label>
						<input name="conservacion" type="text" class="form-control" style="width:100px;"id="inputEmail" placeholder="Numero" value=0>
				  </div>
				<hr  class="divider">
				  <br>
