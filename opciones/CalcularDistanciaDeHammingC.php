...
<html lang="en">
	...
	<?php
	  ...
	  <ul class="pager">
		 <li><a href="CalcularDistanciaDeHammingC.php">Volver</a></li>
	  </ul>

		<div class="bs-example">
			<center>
			 <form action="CalcularDistanciaDeHammingC.php" method="post">
...
NO_MORE;
					...
					echo "<h1>Distancia Hamming secuencias 1 y 2:</h1><br>";
					calcularDistanciaHammming($sec1,$sec2);
					echo "<br><br>";

					echo "<h1>Distancia Hamming secuencias 1 y 3:</h1><br>";
					calcularDistanciaHammming($sec1,$sec3);
					echo "<br><br>";

					echo "<h1>Distancia Hamming secuencias 2 y 3:</h1><br>";
					calcularDistanciaHammming($sec2,$sec3);
					//echo "<br><br>";
					//echo "<b>Rangos:</b><br>";
